    ...
    return (
      <div id='ChronoBox'>
        ...
        <div className='buttonBox'>
          <button className='buttons' onClick={this.iniciar}> Iniciar</button>
          <button className='buttons' onClick={this.parar}> Parar</button>
          <button className='buttons' onClick={this.zerar}> Zerar</button>
        </div>
      </div>
    );
  }
